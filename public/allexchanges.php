        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <?php echo $exchangecount;?> exchanges listed
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">Our goal is to be the first choice when it comes to coin price informations. We crawl listed exchanges raw API data, convert and save them. This allows us to provide human readable code for many coins on many exchanges</p>
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="#AllExchanges">Show all exchanges</a>
          </div>
        </div>
      </div>
    </header>
	<section class="bg-primary" id="AllExchanges">
<div class="container">
        <div class="row">
		...
		<div class="container"> 
			...
			<h5 class="card-header">All listed exchanges<span id="blocks-updated" class="float-right text-success" style="display: none;"><span class="oi oi-flash"></span></h5>
  ...
  ?>
    ...
    <tbody>
		...
		$sqlask = "SELECT displayname, link FROM exchange";
		$resultask = $conn->query($sqlask);
		while ($row = $resultask->fetch_assoc())
			{	
			echo "<tr>";
			echo "<td><a target='_blank' href='".$row["link"]."'' class='text-black'>".$row["displayname"]."</a></td>";
			echo "</tr></a>";
